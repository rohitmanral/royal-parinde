...
ALLOWED_HOSTS = ['royalparindetourandtravel.herokuapp.com', '127.0.0.1']
...
#     }
# }
DATABASES = {'default': dj_database_url.config(default='postgres://postgres:rex12345@localhost/carzone_db')}
